            ...
            <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                <form @submit.prevent="handleEdit">
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.location" type="text" id="location" name="location" class=" 
                  pi pi-map-marker text-orange-700 mr-2
                border rounded w-full py-2 px-3 mb-2" placeholder="Company Location" required />
                    </div>
